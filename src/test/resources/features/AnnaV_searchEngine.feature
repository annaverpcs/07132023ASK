...
Feature: Smoke steps
  ...
  Scenario: Search steps for Ecoru
    ...
    @wiki
    Scenario: Search for https://www.wiki.com/
      Given I open url "https://www.wiki.com/"
      Then I should see page title as "Wiki.com"
      Then element with xpath "//input[@name='q']" should be present
      Then I type "Automation" into element with xpath "//input[@name='q']"
      ...
      Then element with xpath "//*[contains(text(),'Automation')]" should contain text "Automation"
      
      
    @givewater
    Scenario: Search for givewater
      Given I open url "https://www.givewater.com/"
   Then I should see page title contains "giveWater"
